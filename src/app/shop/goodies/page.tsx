...
const goodies = [
  ...
  { name: "Hand Sanitizer", stock: "Out of stock" },
  { name: "Soap Terrarium", stock: "Out of stock" },
  { name: "leaf soap dish", stock: "Out of stock" },
]
      ...
      <section className="hero-forest relative overflow-hidden px-5 pb-20 pt-36 text-[var(--color-cream)] sm:px-8 lg:pt-40">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
          <div>
            ...
            <h1 className="hero-heading mt-10 max-w-4xl uppercase">Goodies</h1>
          </div>
          <div className="rounded-2xl border border-[rgba(250,247,240,0.22)] bg-[rgba(250,247,240,0.08)] p-8 text-center backdrop-blur sm:p-12">
            <p className="font-serif text-4xl leading-tight text-[var(--color-cream)] sm:text-5xl">
              While soaps are our main squeeze,
            </p>
            <p className="mt-5 text-xl leading-8 text-[var(--color-cream)]/82">
              we also carry some awesome treats
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-5 py-16 sm:px-8 lg:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="flex items-end justify-between gap-4 border-b border-[rgba(74,124,82,0.28)] pb-8">
            <div>
              <p className="eyebrow">Goodies</p>
              <h2 className="section-heading mt-3">Treats beyond the bar.</h2>
            </div>
            <p className="hidden font-mono text-xs uppercase tracking-[0.14em] text-[var(--color-moss)] sm:block">
              {goodies.length} items
            </p>
          </div>
